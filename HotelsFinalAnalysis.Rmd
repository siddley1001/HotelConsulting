...
Model 2: step-wise logistic

Model 3: logistic with two-fold interaction

Model 4: k-NN, with k=5

**Need to add RandomTrees models**
...
The logistic models performed the same in terms of accuracy, sensitivity, and specificity. Here is a table of coefficients for the simple logistic model:
