...
q1table = model_data_city %>% 
  ...
  xtable(
    align=c("c","c","c"),
    type="html",
    caption = "Table 1: Example of Average ADR as arrival_date (time elapased) increases")
print(q1table, 
      "html", 
...
q2table = (df %>% select(
  ...
  xtable(
    align="cccccccc", 
    type="html",
    caption = "Table 2: Example of relevant variables for predicting cancellation"
    )
print(q2table,
      "html",
      caption.placement = "top",
...
$81.0966 + 14.66199 \cos(2*pi*x/365.25) + 5.60252 \sin(2*pi*x/365.25) + 0.05533655x$
The mathematical equation for resort hotel data:
$70.12623 + 46.47132 \cos(2*pi*x/365.25) + 26.28031 \sin(2*pi*x/365.25) + 0.04860842x$
